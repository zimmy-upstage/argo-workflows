...
| cluster | string| `string` |  | | Cluster is the cluster the task should run it (if supported). |  |
...
| namespace | string| `string` |  | | Namespace is the name the task should run it (if supported). |  |
